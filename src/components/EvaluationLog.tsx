  ...
  return (
    <Card className="p-6 border-border/50 mt-6">
      <h3 className="font-heading font-semibold text-foreground mb-4 flex items-center gap-2">
        <span className="text-lg">📋</span> Baha beriş jurnaly
      </h3>
        ...
        <div className="space-y-4">
          {logs.map((log, i) => (
            <div key={i} className="border border-border rounded-lg p-4 text-xs font-mono">
              ...
              <div className="mb-2">
                <span className="text-primary font-semibold">Netije:</span>{" "}
                <span className="text-foreground">{log.level} ({Math.round(log.confidence * 100)}%)</span>
              </div>
              <div className="mb-2">
                <span className="text-primary font-semibold">Deslapky ädimler:</span>
              ...
              <details className="cursor-pointer">
                <summary className="text-primary font-semibold">Model çykyşy (çig görnüş)</summary>
